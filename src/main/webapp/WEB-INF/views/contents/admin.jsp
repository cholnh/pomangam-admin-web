	...
	<div class="page-header">
		<h1>
			<span class="text-muted font-weight-light"><i
				class="page-header-icon ion-person-stalker"></i>회원 관리 / </span>운영자 목록
		</h1>
	</div>
	<div class="container">
		...
		<table id="table" data-toggle="table" data-show-refresh="true"
			...
			data-url="./admin/getadminlist.do?tail=order by idx desc">
			<thead>
				<tr>
		...
		<form class="form-horizontal" id="modalform">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="grid-input-5" class="col-md-3 control-label">권한</label>
						<div class="col-md-9">
							<select class="form-control input-lg" id="authnameSelector" required>
...
$(document).ready(function() {
	...
	$("#modalform").submit(function() {
		...
		if(!where) return;
		if($('#authnameSelector').val() == -1) {
			alert('권한 선택은 필수 사항입니다.');
			return false;
		}
